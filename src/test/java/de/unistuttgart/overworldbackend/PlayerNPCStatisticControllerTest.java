...
class PlayerNPCStatisticControllerTest {
    ...
    public void createBasicData() {
        ...
        fullURL = String.format("/lectures/%d/playerstatistics/"+initialPlayerstatistic.getUserId()+"/player-npc-statistics", initialLecture.getId());
    ...
    void getNPCStatistics() throws Exception {
        PlayerNPCStatisticDTO statistic = playerNPCStatisticService.submitData(new PlayerNPCStatisticData(initialNpc.getId(),true,initialPlayerstatistic.getUserId()));
        ...
        final List<PlayerNPCStatisticDTO> playerNPCStatisticDTOs = Arrays.asList(objectMapper.readValue(
